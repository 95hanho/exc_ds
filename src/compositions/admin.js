...
/* 프로그램리스트 */
// 관리자 프로그램리스트 조회
export const getAdminProgram = (year, month) => get_normal(`/v1/expert/application/${year}/${month}`);
// 강의 정보수정
export const setAdminProgram = (obj) => put_urlFormData("/v1/expert/schedule/info", obj);
// 강의 프로그램 차수 등록
...
/* 프로그램리스트->수강생리스트 */
// 관리자 프로그램 신청인원 조회
export const getAdminProgramStudents = (obj) => get_normal("/v1/expert/user/enrollment", obj);
// 출결변경
...
// 교육생 과정차수 등록 해주기
export const adminProgramRegist = (obj) => post_urlFormData("/v1/expert/member/info", obj);
/*  */
// 기본 설정 정보 가져오기
