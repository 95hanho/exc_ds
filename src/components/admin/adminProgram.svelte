<script>
	import { actionCheckedPrograms, getAdminProgram } from './../../compositions/admin.js';
    ...
    import AdminProgramStudents from './adminProgramStudents.svelte';
    ...
    export let openAdminProgramAdd;
    ...
    const initDataFnc = async (year, month) => {
        getProgramAwait = await getAdminProgram(year, month).then(({data}) => {
        ...
        <div class="row">
            ...
            <table id="application-table"
                ...
                <tbody>
                    ...
                    {#if program.onStudents}
                    <AdminProgramStudents curProgram={program} 
